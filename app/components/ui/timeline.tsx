...
const timelineContentVariants = cva("row-start-2 row-end-2 pb-8 text-muted-foreground break-all", {
	variants: {
		side: {
...
const timelineHeadingVariants = cva("row-start-1 row-end-1 line-clamp-1 max-w-full", {
	variants: {
		side: {
			right: "col-start-3 col-end-4 mr-auto text-left",
			left: "col-start-1 col-end-2 ml-auto text-right",
