...
const requiredInDevelopment: z.RefinementEffect<string | undefined>["refinement"] = (value, ctx) => {
...
const envSchema = z.object({
	...
	LOCAL_REPO_RELATIVE_PATH: z.string().optional().superRefine(requiredInDevelopment),
